...
const ALL_LANGUAGES = [
  'Українська','English','Deutsch','Polski','Español','Français','Italiano','中文','日本語'
];

export default function FilterLanguageScreen({ navigation, route }) {
  ...
  const done = () => {
    navigation.navigate({ name: 'Category', params: { languages: Array.from(picked) }, merge: true });
  };
